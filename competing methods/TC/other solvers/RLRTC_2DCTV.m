%-----Robust Low-tubal-rank Tensor Completion via 2D Correlted Total Viariation-----%
function [X,E,obj,err,iter] =RLRTC_2DCTV(M,Omega,Omega_c,opts) 
...
while iter<max_iter
    ...
    %% Update E -- soft-thresholding operator
    temp       = M-X+M3/mu;
    E(Omega)   = prox_l1(temp(Omega),lambda/mu);
    E(Omega_c) = temp(Omega_c);
