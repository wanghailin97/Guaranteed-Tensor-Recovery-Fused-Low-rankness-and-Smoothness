function [L,obj,tsvd_rank] =HTNN_C(X,Omega,opts)

%Low-Rank Order-D(D>3) Tensor Completion under generalized Discrete Cosine Transform (DCT)
...
for iter = 1 : max_iter
    ...
    % update L
    [L,tnnX,trank] =prox_htnn_C(Mbar-E-Y/mu,1/mu); 
